...
// You must create and return a new array, by fulfilling all orders from the orders array. To fulfill an order, create a copy
// of the object’s template and then add to it all functions, listed in the parts array of the order,
//  by taking them from the function library (the first parameter to your solution).
